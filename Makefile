...
lint-py:  ## lint python with ruff
	python -m ruff check nbprint_logfire
	python -m ruff format --check nbprint_logfire
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix nbprint_logfire
	python -m ruff format nbprint_logfire
...
test:  ## run python tests
	python -m pytest -v nbprint_logfire/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v nbprint_logfire/tests --cov=nbprint_logfire --cov-report term-missing --cov-report xml
